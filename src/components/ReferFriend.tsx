...
export const ReferFriend: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
      ...
      event.preventDefault();
        ...
        toast.promise(dispatch(subscribeToWaitlist(phoneNumber, firstName)).then(resp => {
  ...
  const Keypad = ({ onKeyPress }: any) => {
    ...
    const buttons = [1, 2, 3, 4, 5, 6, 7, 8, 9, 'placeholder', 0, 'placeholder'];
      ...
      <div className="grid grid-cols-3 gap-4 p-3">
        {buttons.map((item, index) => (
          item === 'placeholder' ?
            ...
            <button key={item} onClick={() => onKeyPress(item)} 
        ...
        <div className="flex flex-col min-h-screen font-sans -mt-10 bg-gradient-to-b shadow from-white to-gray-50 relative">
          ...
          <div className="container max-w-4xl my-20 mx-auto px-4 py-8 mb-12 shadow-lg bg-[#f8f8f8] rounded-2xl">
            ...
            <div className="items-center justify-center flex flex-col gap-4 mt-16 mb-4">
              ...
              <button onClick={()=>{handleLinkClick("https://apps.apple.com/us/app/college-mixer/id1671245143")}} className="bg-slate-700 rounded-lg p-3 text-white font-semibold transition-all duration-200 hover:bg-pink-600 hover:scale-95">Tap here to view the app in the App Store</button>
    ...
    <>
      <div className="flex flex-col min-h-screen font-sans -mt-10 bg-gradient-to-b shadow from-white to-gray-50 relative">
        ...
        <div className="container max-w-4xl my-20 mx-auto px-4 py-8 mb-12 shadow-lg bg-[#f8f8f8] rounded-2xl">
            ...
            <div className="flex flex-wrap">
              <div className="flex w-full flex-wrap mb-4">
                <div className="w-full mx-auto px-2 mt-4">
                  ...
                  <input className="appearance-none shadow-md block w-full truncate bg-white text-gray-700 border border-gray-200 rounded-lg py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="name" type="text" placeholder="Ashleigh" value={firstName} onChange={(n) => setFirstName(n.target.value)} />
                </div>
              </div>
              ...
              <div className='w-full px-2 '>
                ...
                <input className="appearance-none shadow-md block w-full bg-white text-gray-700 border rounded-lg py-3 px-4 mb-3 leading-tight" id="phone-number" type="tel" placeholder="519-583-1850" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
              </div>
          ...
          {/* <img src={TiresImg} alt="Tires" className=" absolute invisible -mr-4 lg:visible bottom-44 z-5 left-0 lg:w-40  xl:w-64 h-auto " /> */}
          <div className="flex justify-center items-center pt-6 pb-2 ">
            <span className="mr-3 text-sm text-gray-700 ">Guelph Mixer is not affiliated with Guelph University</span>
          </div>
          <div className="flex justify-center items-center pt-2 pb-2 ">
            {/* <span className="mr-3 text-sm text-gray-700 ">We'll send you updates periodically with reminders and more information</span> */}
          </div>
